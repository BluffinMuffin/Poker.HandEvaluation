...
{
    [TestClass]
    public class CardSelectorOnlyHandTest : TestBase<CardSelectorOnlyHand>
    {
        [TestClass]
        public class SelectCards : CardSelectorOnlyHandTest
        {
            [TestMethod]
            ...
            public void When_HappyPath_Expect_CorrectlyBuilt()
            {
                ...
                var expected = AutoFixture.Freeze<ICardHelper>()
                                          .AllCombinations(player.HandCards, 5);
